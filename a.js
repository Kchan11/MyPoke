...
// メイン処理
async function main() {
    // 配列内の各ポケモン番号に対してカードを生成
    for (const pokeNo of pokeNoArr) {
        await createPokemonCard(pokeNo);
    }
